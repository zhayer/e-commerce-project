<div class="wpdevart-header-container">
    ...
    <div role="navigation" class="<?php if (get_theme_mod( 'wpdevart_jewstore_header_show_action_button', '1' )) { echo esc_attr('nav-container-without-action-button'); } else { echo esc_attr('nav-container-layout-one'); } ?>">
    ...
    <?php if ( class_exists( 'WooCommerce' ) ) { ?>
            ...
            <div class="header-cart">
				...
				<?php wpdevart_jewstore_header_cart_layout_one() ?>
            </div>   
    <?php } ?>
