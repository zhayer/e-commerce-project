...
const ScPaymentMethodChoice = class {
    ...
    render() {
        ...
        return (h(Tag, { key: '15615764bcbc44710b31430388c108522e394d6e', "show-control": true, borderless: true, open: this.isSelected(), onScShow: () => {
                state.id = this.processorId;
                state.manual = !!this.isManual;
                state.method = this.methodId;
            } }, this.hasOthers() && h("slot", { key: '3f4eede11f01abd2697fa0004f436c2356d72176', name: "summary", slot: "summary" }), this.card && !this.hasOthers() ? (h("sc-card", null, h("slot", null))) : (h("slot", null))));
    }
...
const ScPaymentSelected = class {
    ...
    render() {
        return (h("div", { key: '4aa3a78fc38c5d59506b00ee504c3ed21565bcce', class: "payment-selected", part: "base" }, h("slot", { key: 'cfdc7721bb017b74c95a5d745bfce99fdff58b8a', name: "icon" }), h("div", { key: '2d28f760921e6daed13840eb7188ea91c67a7eaf', class: "payment-selected__label" }, this.label), h("sc-divider", { key: '1f561482f530e031b333ef34659cb32f4b5c7f87', style: { '--spacing': 'var(--sc-spacing-xx-small)' }, exportparts: "base:divider, line:divider__line" }), h("div", { key: '6716989f2e67f04b868d68c9cc4356c1af2f9bd3', part: "instructions", class: "payment-selected__instructions" }, h("svg", { key: '7a1ba67f635a03bf7f1fd9d1a61ce69ecadb1b59', part: "icon", viewBox: "0 0 48 40", fill: "var(--sc-color-gray-500)", xmlns: "http://www.w3.org/2000/svg", role: "presentation" }, h("path", { key: '3976b62e7276812980fcbabedb1b8cc03284ccc2', opacity: ".6", "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M43 5a4 4 0 00-4-4H17a4 4 0 00-4 4v11a1 1 0 102 0V5a2 2 0 012-2h22a2 2 0 012 2v30a2 2 0 01-2 2H17a2 2 0 01-2-2v-9a1 1 0 10-2 0v9a4 4 0 004 4h22a4 4 0 004-4V5zM17.992 16.409L21.583 20H6a1 1 0 100 2h15.583l-3.591 3.591a1 1 0 101.415 1.416l5.3-5.3a1 1 0 000-1.414l-5.3-5.3a1 1 0 10-1.415 1.416zM17 6a1 1 0 011-1h15a1 1 0 011 1v2a1 1 0 01-1 1H18a1 1 0 01-1-1V6zm21-1a1 1 0 100 2 1 1 0 000-2z" })), h("div", { key: 'ccf0b7600630c292173f7df49bab2f1bd8747fad', part: "text", class: "payment-selected__instructions-text" }, h("slot", { key: '408db7f701bf237a74b7210fe44872017dba9234' })))));
    }
};
