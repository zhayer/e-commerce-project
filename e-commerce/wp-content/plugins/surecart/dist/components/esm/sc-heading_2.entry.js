...
const ScHeading = class {
    ...
    render() {
        return (h("div", { key: '4f8cfcc9dfdf2a69908d98fba958c2cf1ae2cbae', part: "base", class: {
                'heading': true,
                'heading--small': this.size === 'small',
                'heading--medium': this.size === 'medium',
                'heading--large': this.size === 'large',
            } }, h("div", { key: '17f4b7d485e5979fae0a075077e34a1ac37cdeb5', class: { heading__text: true } }, h("div", { key: 'd742ee0a5188171175252fd22098ea44ea9fbd7a', class: "heading__title", part: "title" }, h("slot", { key: '23f0bf8fa532646310837b5362cc68880bf3ea7d' })), h("div", { key: '7e6e4eadd08437a75dab7cccdd4427e7ae35d983', class: "heading__description", part: "description" }, h("slot", { key: '2ad1f6adea182e4b10c7f1150a2db73cf94c1db0', name: "description" }))), h("slot", { key: 'a6b57db07ed198149111ddae37dbac4d51e4dec5', name: "end" })));
    }
...
const ScOrderConfirmComponentsValidator = class {
    ...
    render() {
        return h("slot", { key: 'c0dd3f7ec590a7ff1f482f0f135fcda14c2ff1ca' });
    }
    get el() { return getElement(this); }
