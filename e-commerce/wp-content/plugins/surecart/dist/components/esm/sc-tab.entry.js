...
const ScTab = class {
    ...
    render() {
        ...
        return (h(Tag, { key: '2cf5bb1143886b64d50d4e6f0b370b57a0cb8209', part: `base ${this.active ? `active` : ``}`, href: this.href, class: {
                'tab': true,
