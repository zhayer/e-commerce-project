...
const ScMenuLabel = class {
    ...
    render() {
        return (h("div", { key: 'ec6629a4c6e8873907249335f49ae48ce3e5ef25', part: "base", class: "menu-label" }, h("slot", { key: 'a541eddf938bdf31430e690a0881de84476af1e9' })));
    }
};
...
const ScSelectDropdown = class {
    ...
    render() {
        var _a;
        return (h("div", { key: 'c82376442f9a0b4ce674e8397fda8ff88fc62a75', part: "base", class: {
                'select': true,
            ...
            } }, h("sc-form-control", { key: 'a054da42fbbc1a940c100e3e683fef6a81577b0d', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("input", { key: '35b004bd438cd31ba015156ac033c988ad017087', class: "select__hidden-input", name: this.name, ref: el => (this.input = el), value: this.value, required: this.required, disabled: this.disabled, "aria-hidden": "true", "aria-label": this.displayValue() || this.label || this.placeholder, onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus() }), h("sc-dropdown", { key: '3093a3f0446a66f2eb1b160d0316a3ef22797242', exportparts: "trigger, panel", disabled: this.disabled, open: this.open, closeOnSelect: this.closeOnSelect, position: this.position, placement: this.placement, hoist: this.hoist, style: { '--panel-width': '100%' }, onScShow: () => this.handleShow(), onScHide: () => this.handleHide(), role: "select", "aria-open": this.open ? 'true' : 'false' }, h("slot", { key: '5f09d9a60853bdca22163aadd4d5b3f804e43b46', name: "trigger", slot: "trigger" }, h("div", { key: '9ad0690187536e6a8d4a266e86a5d10ebc12de56', class: "trigger", role: "button", tabIndex: -1, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, h("div", { key: '78e8d9b498854c0f1c95a46791893d2637918a21', class: "select__value" }, h("slot", { key: '2d934f783c307a70871c393564c4acf99c5b181a' }, this.displayValue() || this.placeholder || wp.i18n.__('Select...', 'surecart'))), h("sc-icon", { key: 'b8fc77aaa75b3eb546fd626f1db1fa5f4b15b771', exportparts: "base:caret", class: "select__caret", name: "chevron-down" }))), this.search && (h("sc-input", { key: 'f97c552f7b7ae7d74b20d7d91396c84955fcb755', exportparts: "base:search__base, input:search__input, form-control:search__form-control", placeholder: this.searchPlaceholder || wp.i18n.__('Search...', 'surecart'), onScInput: e => this.handleQuery(e), class: "search", clearable: true, part: "search", value: this.searchTerm, ref: el => (this.searchInput = el), "aria-label": wp.i18n.__('Type to search', 'surecart'), onKeyDown: e => e.stopPropagation() }, this.loading && h("sc-spinner", { key: '6cc900fb4694e5be272c9cc2848e28da52235707', exportparts: "base:spinner__base", style: { '--spinner-size': '0.5em' }, slot: "suffix" }))), h("sc-menu", { key: '5fac7a62c9364d6b64c79e479f3973d6cd9c98a2', style: { maxHeight: '210px', overflow: 'auto' }, exportparts: "base:menu__base", onScroll: e => this.handleMenuScroll(e), "aria-multiselectable": "false" }, h("slot", { key: '1372af914bb93d11cdd32c25e60c9b7062b559d4', name: "prefix" }), (this.filteredChoices || []).map((choice, index) => {
            return [this.renderItem(choice, index), (choice.choices || []).map(choice => this.renderItem(choice, index))];
        }), this.loading && (h("div", { key: 'dc0058e82499ff4467979ecb52e2d243445fd641', class: "loading" }, h("sc-spinner", { key: '7a89645fa082a4f9ec8ba0525a7c134a6cdc53b0', exportparts: "base:spinner__base" }))), !this.loading && !this.filteredChoices.length && (h("div", { key: 'ba357fe8276e284df9095400b19aaf35b5c53491', class: "select__empty", part: "empty" }, wp.i18n.__('Nothing Found', 'surecart'))), h("slot", { key: 'd5dd417c7bcd7e805d49951e4e069ff320555a34', name: "suffix" }))))));
    }
