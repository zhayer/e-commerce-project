...
const ScPhoneInput = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '7d71d637ef2b5d19a59e481496ff70628c4c1cac', hidden: this.hidden }, index.h("sc-form-control", { key: '840cba30243246705a163fcf15e1157a7c404038', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name, "aria-label": this.label }, index.h("slot", { key: 'd5cc930ace2e590bc39c05a84b19dd9ea2c6a04a', name: "label-end", slot: "label-end" }), index.h("div", { key: '003e513902335a1fb78be6fffc9f99da13ce6148', part: "base", class: {
                'input': true,
                // Sizes
            ...
            } }, index.h("span", { key: 'ca4a7c48a748f237913426d28a7c1f82bf876d17', part: "prefix", class: "input__prefix" }, index.h("slot", { key: 'b1087e8b55ae8e42dfac441dfacd7a863be5b57b', name: "prefix" })), index.h("slot", { key: 'bde73162e748c9487eee8519669eaa8ec170b8af' }, index.h("input", { key: 'fafd85497e3220e3898b26fe99545597252fe8fc', part: "input", id: this.inputId, class: "input__control", ref: el => (this.input = el), type: "tel", name: this.name, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step,
            // TODO: Test These below
            autocomplete: 'tel', autocorrect: this.autocorrect, autofocus: this.autofocus, spellcheck: this.spellcheck, pattern: index$1.applyFilters('surecart/sc-phone-input/pattern', this.pattern), inputmode: 'numeric', "aria-label": this.label, "aria-labelledby": this.label, "aria-invalid": this.invalid ? true : false, value: this.value, onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() })), index.h("span", { key: '6674002c61c8c4ffe2af59aa4018b27b330be8a4', part: "suffix", class: "input__suffix" }, index.h("slot", { key: 'f3ba8b4d57e0d1c34796f96faff47e4d11bc798c', name: "suffix" })), this.clearable && ((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) > 0 && (index.h("button", { key: '17771c9943bd270871e9590488a6fa332db6d45d', part: "clear-button", class: "input__clear", type: "button", onClick: e => this.handleClearClick(e), tabindex: "-1" }, index.h("slot", { key: '487bf7449d9e4e5715699663d81336d4a4a95578', name: "clear-icon" }, index.h("svg", { key: 'e5059c69c641a291ea8b196d252e6fb7748cbdb2', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "feather feather-x" }, index.h("line", { key: '803d7579ecb1e77ecdb55ab4439f41ccbffe4d24', x1: "18", y1: "6", x2: "6", y2: "18" }), index.h("line", { key: 'a817cc17ca8a2e55d21a70c7bd6db8261c810bbc', x1: "6", y1: "6", x2: "18", y2: "18" })))))))));
    }
