...
const ScBreadcrumbs = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: 'f33708c21b9951084724cd207b13a3ef14f70420' }, index.h("nav", { key: 'ef776f07eec4d5a2e754a7895c6e43308d02b7b7', part: "base", class: "breadcrumb", "aria-label": this.label }, index.h("slot", { key: '8c4efc22225ef46e2c423bae78d9396067ef08bb', onSlotchange: () => this.handleSlotChange() })), index.h("div", { key: '109e7ec38dc3d0a598f473d5422ab4dfb5d134b2', part: "separator", hidden: true, "aria-hidden": "true" }, index.h("slot", { key: 'a663890c8aa67f710a9818c3d12c0db54348f7ff', name: "separator" }, index.h("sc-icon", { key: 'dbb8393d11f1a9f3fe5585e7caf3380e9fb5f2aa', name: "chevron-right" })))));
    }
