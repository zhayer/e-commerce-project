...
const ScButtonGroup = class {
    ...
    render() {
        return (index.h("sc-form-control", { key: 'f919642c282c7a6efe674321c25964e917909d17', part: "base", class: {
                'button-group': true,
                'button-group--separate': this.separate,
            }, role: "group", "aria-label": this.label, onFocusout: e => this.handleBlur(e), onFocusin: e => this.handleFocus(e), onMouseOver: e => this.handleMouseOver(e), onMouseOut: e => this.handleMouseOut(e), label: this.label }, index.h("slot", { key: 'ed7e141319513481169a5dba1fbe890938b5e9d1', onSlotchange: () => this.handleSlotChange() })));
    }
