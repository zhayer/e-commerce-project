...
const ScRichText = class {
    ...
    render() {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return (index.h(index.Host, { key: 'c38442cf221a7ba625ede10c595300298ff82a94' }, index.h("sc-form-control", { key: '40bfeaf65e8e48df2ebbe4cde751f6c16128ed8f', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("div", { key: '256c471c9995d7774ef2928cc2cc387c1d23a49d', part: "base", class: { 'editor-base': true, 'editor--focused': this.hasFocus } }, index.h("div", { key: '45713f2450193fd25ad2f19486cef533843c5e9e', class: "menu" }, index.h("sc-button", { key: '381ed716530c15e32f24ec287c332de9c2062f8f', size: "small", type: ((_b = (_a = this.editor) === null || _a === void 0 ? void 0 : _a.isActive) === null || _b === void 0 ? void 0 : _b.call(_a, 'bold')) ? 'default' : 'text', onClick: () => this.run('toggleBold'), disabled: !this.can('toggleBold') }, index.h("sc-icon", { key: 'cb94b839cf0ea63f96aeee2b62d7e37e3ba3152e', name: "bold" })), index.h("sc-button", { key: 'bef6888524567e7c0d83afb8f56111107bb5d2ae', size: "small", type: ((_d = (_c = this.editor) === null || _c === void 0 ? void 0 : _c.isActive) === null || _d === void 0 ? void 0 : _d.call(_c, 'italic')) ? 'default' : 'text', onClick: () => this.run('toggleItalic'), disabled: !this.can('toggleItalic') }, index.h("sc-icon", { key: '16c7622a9287e32c563ee7ff152c3cfb1f06d314', name: "italic" })), index.h("sc-button", { key: '5a07464a7138eafeff1c3739f6060f1446196d11', size: "small", type: ((_f = (_e = this.editor) === null || _e === void 0 ? void 0 : _e.isActive) === null || _f === void 0 ? void 0 : _f.call(_e, 'bulletList')) ? 'default' : 'text', onClick: () => this.run('toggleBulletList') }, index.h("sc-icon", { key: 'c1e0b58365a870de812e86f5e96a58c0757c4a43', name: "list" })), index.h("sc-button", { key: 'e347089ad5e93bf75366e5b182643ef8df0cdcd6', size: "small", type: ((_h = (_g = this.editor) === null || _g === void 0 ? void 0 : _g.isActive) === null || _h === void 0 ? void 0 : _h.call(_g, 'strike')) ? 'default' : 'text', onClick: () => this.run('toggleStrike') }, index.h("sc-icon", { key: 'b497cd610daa97fb111a26fc5c9a1cc1949dd8ad', name: "minus" })), index.h("sc-button", { key: '3b234be6e543057932ceaa21801609b6bf820997', class: "right", size: "small", type: "text", onClick: () => this.run('undo'), disabled: !this.can('undo') }, index.h("sc-icon", { key: '72095b9ca54fe98dc91094c54fd70d14ef66fac8', name: "corner-up-left" })), index.h("sc-button", { key: '63ba4ad2f2b102eb1cc1fb02afb8143689cbfc75', size: "small", type: "text", onClick: () => this.run('redo'), disabled: !this.can('redo') }, index.h("sc-icon", { key: 'c5882eb2add59ed91a7567cea56202a96fe9d044', name: "corner-up-right" }))), index.h("div", { key: '1d96180c36d76779507dacadae207a72bcbc71af', part: "editor", class: {
                editor: true,
            }, ref: el => (this.element = el) })), this.remainingCharacters() < 20 && index.h("div", { key: '5661c34e02e999ebd17352ba8c382bc5be37ad3c', class: 'textarea__char-limit-warning' }, wp.i18n.sprintf(wp.i18n.__('%d characters remaining', 'surecart'), this.remainingCharacters())))));
    }
};
